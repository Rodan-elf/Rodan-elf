...
|---|---|---|
| [lab-castlexxx-recon](https://github.com/Rodan-elf/lab-castlexxx-recon) | Reconnaissance | Web infrastructure enumeration > port scanning, DNS zone transfer exploitation, directory brute-forcing and hidden admin portal discovery |
